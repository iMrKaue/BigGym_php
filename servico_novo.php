...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($nome && !$erro) {
        $db = getDB();
        $stmt = $db->prepare('INSERT INTO servicos (nome, descricao, imagem) VALUES (?, ?, ?)');
...
<head>
    <meta charset="UTF-8">
    <title>Novo Serviço - BigGym</title>
...
<body>
    ...
    <main>
        <h2 style="text-align:center; color:#ee0606;">Adicionar Novo Serviço</h2>
        <form method="post" class="form-servico" enctype="multipart/form-data">
            ...
            <label for="imagem_upload">Imagem do Serviço (envie um arquivo)</label>
